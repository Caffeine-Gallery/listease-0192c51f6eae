...
actor {
    ...
    private var items = HashMap.HashMap<Nat, ShoppingItem>(10, Nat.equal, Hash.hash);
    ...
    system func postupgrade() {
        items := HashMap.fromIter<Nat, ShoppingItem>(itemEntries.vals(), 10, Nat.equal, Hash.hash);
    };
